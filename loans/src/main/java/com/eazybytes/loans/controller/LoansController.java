...
public class LoansController {
	...
	@PostMapping("/myLoans")
	public List<Loans> getLoansDetails(@RequestHeader("aggeles-correlation-id") String correlationid, @RequestBody Customer customer) {
		...
		if (loans != null) {
			...
			logger.info("getLoansDetails() method returned null");
			return null;
		}
